...
echo "<pre>";
var_dump(find_path($graph, 'GABOR', 'ZOLTAN'));
echo "</pre>";
echo "<hr />";

echo "<pre>";
var_dump(find_path($graph, 'ARMIN', 'TIHAMER'));
echo "</pre>";
echo "<hr />";

echo "<pre>";
var_dump(find_path($graph, 'ANDRAS', 'GEZA'));
echo "</pre>";
echo "<hr />";

echo "<pre>";
var_dump(find_path($graph, 'FERENC', 'AGOSTON'));
echo "</pre>";
echo "<hr />";

echo "<pre>";
var_dump(find_path($graph, 'BALAZS', 'BELA'));
echo "</pre>";
echo "<hr />";

echo "<pre>";
var_dump(find_path($graph, 'BALAZS', 'UBUL'));
echo "</pre>";
echo "<hr />";

echo "<pre>";
var_dump(find_path($graph, 'BELA', 'GEZA'));
echo "</pre>";
echo "<hr />";
