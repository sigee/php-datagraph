<?php
	...
	echo "<pre>"; var_dump(find_path($g, 'GABOR', 'ZOLTAN')); echo "</pre>";
	echo "<hr />";

	echo "<pre>"; var_dump(find_path($g, 'ARMIN', 'TIHAMER')); echo "</pre>";
	echo "<hr />";

	echo "<pre>"; var_dump(find_path($g, 'ANDRAS', 'GEZA')); echo "</pre>";
	echo "<hr />";

	echo "<pre>"; var_dump(find_path($g, 'FERENC', 'AGOSTON')); echo "</pre>";
	echo "<hr />";

	echo "<pre>"; var_dump(find_path($g, 'BALAZS', 'BELA')); echo "</pre>";
	echo "<hr />";

	echo "<pre>"; var_dump(find_path($g, 'BALAZS', 'UBUL')); echo "</pre>";
	echo "<hr />";

	echo "<pre>"; var_dump(find_path($g, 'BELA', 'GEZA')); echo "</pre>";
	echo "<hr />";
